...
export const Location = () => {
  ...
  return <article ref={container} className={styles.location}>
    <div className={styles.location__container}>
      <p className={`${styles.location__header} heading--h2`}>Our Location</p>
      <div className={`${styles.location__wrapper} hide--left ${isVisible ? 'show' : ''}`}>
        <div>
        ...
        <a className={`${styles.location__img} hide--right ${isVisible ? 'show' : ''}`} href="http://" target="_blank" rel="noopener noreferrer">
        </a>
      </div>
    </div>
  </article>
